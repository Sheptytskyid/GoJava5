...
public class TripAdvisorAPI extends AbstractAPI {
    ...
    public TripAdvisorAPI() {
        ...
        rooms[2] = new Room(getPositiveLongRandomId(), 1400, 3, new Date(116, 11, 14), "Ibis", "Kyiv");
        rooms[3] = new Room(getPositiveLongRandomId(), 1500, 4, new Date(116, 11, 16), "Intercontinental", "Kyiv");
        rooms[4] = new Room(getPositiveLongRandomId(), 1600, 4, new Date(116, 11, 18), "Mir", "Kyiv");
    }
